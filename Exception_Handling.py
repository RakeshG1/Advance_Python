...
if __name__ == "__main__":
    ...
    print("*********************************************************")
    context_manager_examp = With_Example(logfile_path)
    context_manager_examp.read_log_data()
    print("*********************************************************")
    ...
    print("**************************************************")
    open_examp = Open_Example(logfile_path, file_read_mode)
    open_examp.read_log_data()
    print("**************************************************")
